...
public class ExpenseService {
    ...
    public PaymentGraph getPaymentGraph(BalanceMap groupBalances) {
        ...
        while (!positiveAmounts.isEmpty()) {
            ...
            final int largestPositive = positiveAmounts.poll();
            final Object largestNegative = negativeAmounts.poll();
            final Object negativeAmount = -largestNegative.getValue().getAmount();
            final Object positiveAmount = largestPositive.getValue().getAmount();
            ...
            final Object remainingAmount = new Amount(USD, remaining);
            if (remaining > 0) {
