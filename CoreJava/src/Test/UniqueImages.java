...
class UniqueImages {
    ...
    public static void main(String[] args) {
		/*
		 * Image[] images = {new Image("flag.jpg", 40, 60), new Image("flag.gif", 40,
		 * 60), new Image("smile.gif", 100, 200), new Image("smile.gif", 50, 400), new
		 * Image("other.jpg", 40, 60), new Image("lenna.jpg", 512, 512), new
		 * Image("Lenna.jpg", 512, 512)};
		 * 
		 * Set<Image> set = new HashSet<Image>(Arrays.asList(images));
		 * UniqueImages.printImages(set);
		 */
    	
    	HashMap<Image, Integer> hm = new HashMap<Image, Integer>();
    	hm.put(new Image("flag.jpg", 40, 60), 34);
    	hm.put(new Image("flag.jpg", 40, 60), 90);
    	hm.put(new Image("smile.gif", 100, 200), 100);
    	hm.put(new Image("smile.gif", 50, 400), 200);
