...
public class SingleNumberThrice {
	...
	/**
	 * Single Number II Problem Description
	 * 
	...
	public static void main(String[] args) {
		...
		System.out.println(new SingleNumberThrice().singleNumber(arr));
	}
