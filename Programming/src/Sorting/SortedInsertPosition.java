...
public class SortedInsertPosition {
	/**
	 * Sorted Insert Position Problem Description
	 * 
	 * Given a sorted array A of size N and a target value B, return the index
	 * (0-based indexing) if the target is found. If not, return the index where it
	 ...
	 * 
	 * The target value is present at index 2. Explanation 2:
	 * 
	...
	public static void main(String[] args) {
		int arr [] = {1, 3, 5, 6};
		int B = 5;
		System.out.println(new SortedInsertPosition().searchInsert(arr, B));
	}
